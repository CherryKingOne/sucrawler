...
class PlaywrightDownloader(BaseDownloaderImpl):
    ...
    async def open(self) -> None:
        ...
        if self._page is None:
            ...
            logger.info("Playwright downloader opened")
    ...
    async def close(self) -> None:
        ...
        logger.info("Playwright downloader closed")
    ...
    async def _do_fetch(self, request: Request) -> Response:
        ...
        if self._page is None or self._browser_manager is None:
            raise DownloadException("Playwright downloader not initialized")
        ...
        try:
            ...
            msg = f"Playwright downloader error for {request.url}: {e!s}"
