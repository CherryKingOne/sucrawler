...
def main() -> None:
    ...
    crawl_user_parser.add_argument("--max-notes", "-n", type=int, default=0, help="爬取笔记数量上限 (0=全部)")
    ...
    crawl_user_parser.add_argument("--browser", action="store_true", default=False, help="使用浏览器模式 (CDP) 爬取（Bilibili 默认启用）")
    crawl_user_parser.add_argument("--no-browser", action="store_true", default=False, help="禁用浏览器模式（仅 Bilibili 有效）")
